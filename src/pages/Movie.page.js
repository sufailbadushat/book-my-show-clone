...
import MovieHero from "../componets/MovieHero/MovieHero.components";
import { BiCameraMovie } from "react-icons/bi";

const launchRazorPay = () => {
  let options = {
    key: "rzp_test_jHrd0nGKF2YFtD",
    amount: 500 * 100,
    currency: "INR",
    ...
    <>
      ...
      <div className="my-12 container  px-4 lg:w-1/2 lg:ml-64 ">
        <div className="flex flex-col items-start gap-3">
          <h2 className="text-green-900 font-bold text-2xl">About the movie</h2>
          <p>
        ...
        <div className="flex flex-col items-start gap-3">
          ...
          <div className="flex items-start gap-2 bg-yellow-100 border-yellow-400 border-dashed border-2 rounded-md p-2 w-96 ">
        ...
        <div>
          <div className="text-2xl leading-7 font-bold ">Cast</div>
          <div></div>
        </div>
      </div>
    </>
